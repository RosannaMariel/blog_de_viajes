...
from .views import AgregarCategoria, AgregarPais, AgregarPost, ActualizarPost, AgregarRegion, EliminarPost, ListarPost, leer_post, listar_post_por_categoria, ordenar_por
...
urlpatterns = [
    ...
    path("agregar_region/", AgregarRegion.as_view(), name='agregar_region'),
    path("agregar_pais/", AgregarPais.as_view(), name='agregar_pais')
]
